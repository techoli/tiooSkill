...
function ChooseCICD() {
  return (
    <div className="bg-[#0E096C] px-24  text-[#FFFF] py-14">
      <div className="flex gap-10">
        <div className="flex-1 mt-5">
          <img src={choose1} className="h-full object-cover" />
        </div>
        <div className=" flex-1 text-[56px] relative ">
          <h1 className="text-[48px] text-[#FFFF]">Why Choose CICD?</h1>
          {CICDdata?.map((items) => (
            <div key={items.id} className="flex gap-3 mt-5 ">
              ...
              <div className="  w-[90%]">
                <h1 className="text-[30px] text-[#FFFF]">{items.heading}</h1>
                <p className="text-[16px] text-[#FFFF]">{items.text}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="w-[60%] m-[auto] mt-20">
        <h1 className="text-[50px] text-center text-[#FFFF] ">Our Courses</h1>
        <p className="text-[16px] text-[#FFFF] text-center">
      ...
      <div className="flex mt-10 gap-10">
        <div className=" flex-1 text-[56px] relative">
          {CICDdata2?.map((items) => (
            <div key={items.id} className=" border-[#87909E] border-b-2 mt-5">
              <h1 className="text-[30px] text-[#FFFF]">{items.heading}</h1>
              <p className="text-[16px] mb-5 text-[#FFFF]">{items.text}</p>
        ...
        <div className="flex-1 mt-8">
          <img src={choose2} className="h-[656px] object-cover" />
        </div>
      </div>
    </div>
  );
