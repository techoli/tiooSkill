...
function Aboutus() {
  return (
    <div className=" px-16 text-[#413f69]  mt-10">
      ...
      <div className="bg-[#e3e2ff] py-10 px-10 rounded-[15px] mt-16">
        <div className="flex gap-4">
          <div className="flex-1">
            <h1 className="text-[50px]">Real-World Experience</h1>
            ...
            <h2 className="text-[30px] mt-4 mb-5">Internship highlights</h2>
        ...
        <h2 className="text-[50px] mt-10 text-center">Success stories</h2>
        <div className="w-full successimg h-[610px] text-center px-20 py-14">
          <Link
            to="/"
            className="underline text-[32px] text-[#FFF] text-center"
          >
