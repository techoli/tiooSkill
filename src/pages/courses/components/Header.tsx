  ...
  return (
    <>
      <div className="bg-[#E3E2FF] px-4 sm:px-20 py-20 relative  ">
        <AiOutlineRight
          onClick={() => toggleNav("r")}
          className={` sm:block hidden z-10 absolute right-[3px] sm:right-[20px] top-[380px] h-[24px] sm:h-[48px] w-[24px] sm:w-[48px] ${
            activeright && `fill-[gray]`
          }`}
        />
        <AiOutlineLeft
          onClick={() => toggleNav("l")}
          className={`sm:block hidden z-10 absolute left-[3px] sm:left-[20px] top-[380px] h-[24px] sm:h-[48px] w-[24px] sm:w-[48px] ${
                ...
                <div className="flex gap-3 h-[130px]">
                  ...
                  <div className="w-[55%] flex flex-col justify-between p-2">
                    ...
                    <button
                      ...
                      className="  border-[#4F46E5] border-2 w-[160px] h-[30px] rounded-[8px]"
                    >
                      download
                    </button>
                  </div>
