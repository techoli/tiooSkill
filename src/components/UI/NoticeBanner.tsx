...
function NoticeBanner() {
  ...
  return (
    <div
      className={` items-center justify-center flex px-36 py-5 z-50 fixed w-full h-[50px] bg-[#FFF] top-[69px] gap-5 ${
        !shownotice && `hidden`
      }`}
    >
      ...
      <div className="absolute cursor-pointer right-[70px] " onClick={doAction}>
